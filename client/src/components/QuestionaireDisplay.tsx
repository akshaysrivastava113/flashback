...
export default function QuestionaireDisplay(props: any) {
    ...
    return (
        <div onClick={() => navigate('/'+props.id)} style={{ backgroundImage: `url(${props.bgImage})` }} className="border-2 bg-cover bg-center w-64 h-64 rounded-lg m-2 p-2 cursor-pointer hover:bg-opacity-30">
